...
public class Entities {
    ...
    public static void init(CommonProxy commonProxy) {
        ...
        new EntityConfiguration.Builder()
                ...
                .withEquipmentOption(Guns.M1911, EnumDifficulty.HARD, 0.1f, Magazines.M1911_44Mag)
                .withEquipmentOption(Guns.HK_P12, EnumDifficulty.HARD, 0.1f, Magazines.USP45Mag)
                .withEquipmentOption(Guns.MakarovPM, EnumDifficulty.HARD, 0.1f, Magazines.MakarovMag)
                .withEquipmentOption(Guns.MaresLeg, EnumDifficulty.HARD, 0.1f)
                .withEquipmentOption(Guns.M1873, EnumDifficulty.HARD, 0.1f)
                .withEquipmentOption(Guns.G2Contender, EnumDifficulty.HARD, 0.1f)
                .withEquipmentOption(Guns.KragJorgensen, EnumDifficulty.HARD, 0.05f)
                .withEquipmentOption(Guns.M1941JohnsonRifle, EnumDifficulty.HARD, 0.05f)
                .withEquipmentOption(Guns.Kar98K, EnumDifficulty.HARD, 0.03f)
                .withPrimaryEquipmentDropChance(0.1f)
...
//      .withStepSound("step")
                ...
                .withAiTask(2, e -> new EntityAIAvoidEntity<>((EntityCreature) e, CustomBaseZombie.class, 16.0F, 1.0D, 1.5D))
